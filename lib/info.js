...
const VIDEO_URL = `https://cors-anywhere.herokuapp.com/${encodeURIComponent('https://www.youtube.com/watch?v=')}`;
const EMBED_URL = `https://cors-anywhere.herokuapp.com/${encodeURIComponent('https://www.youtube.com/embed/')}`;
const VIDEO_EURL = `https://cors-anywhere.herokuapp.com/${encodeURIComponent('https://youtube.googleapis.com/v/')}`;
const INFO_HOST = `https://cors-anywhere.herokuapp.com/${encodeURIComponent('www.youtube.com')}`;
